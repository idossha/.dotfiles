...
use ~/.cache/starship/init.nu_ansi_coloring: true
    ...
    shell_integration: {
        ...
        # 133, mib, gb, gib, tb, tib, pb, pib, eb, eib, auto
    }
    ...
    usee_external_resolved: light_yellow_bold
    shape_filepath: cyan
